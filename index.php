        ...
        <form class="d-flex" action="crud_empleados.php" method="post" >
            ...
            <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="drop_Puesto" id="drop_Puesto">
                        ...
                        $db_conexion ->real_query("select id_Puesto as id_Puesto,Puesto from Puestos;");
            ...
            <table class="table table-striped table-inverse table-responsive">
                ...
                <?php
                        include("datos_conexion.php");
                        $db_conexion = mysqli_connect($db_host,$db_usr,$db_pass,$db_nombre);
                        $db_conexion ->real_query("SELECT e.id_Empleados as id,e.Codigo,e.Nombres,e.Apellidos,e.Dirección,e.Telefono,p.Puesto,e.fecha_nacimiento,e.id_puesto FROM empleados as e inner join puestos as p on e.id_Puesto = p.id_Puesto;
                        ");
                        $resultado = $db_conexion->use_result();
                        while($fila = $resultado->fetch_assoc()){
